...
public class AnswerDaoSqls {
	public static final String SELECT_ANSWERS_BY_QUESTION_ID ="SELECT answer.id, user_id, content, question_id, answer.create_date, name as userName, email as userEmail FROM answer, service_user WHERE service_user.id = user_id and question_id = :questionId;";
