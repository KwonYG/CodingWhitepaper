...
<body>
    ...
    <form name="join" method="post" onsubmit="return validate();" action="join" class="form-horizontal">
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input id="idInput" type="text" name="serviceId" placeholder="사용자 아이디" required>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input id="pwInput" type="password" name="password" placeholder="사용자 비밀번호" required>
            </div>
        </div>
        <div class="form-group">
            <label for="inputPassword3" class="col-sm-2 control-label">Password 확인</label>
            <div class="col-sm-10">
                <input id="pwCheckInput" type="password" placeholder="사용자 비밀번호 확인" required>
            </div>
        </div>
        <div class="form-group">
            <label for="inputPassword3" class="col-sm-2 control-label">name</label>
            <div class="col-sm-10">
                <input id="nameInput" type="text" name="name" placeholder="사용자 이름" required>
            </div>
        </div>
        <div class="form-group">
            <label for="inputPassword3" class="col-sm-2 control-label">email</label>
            <div class="col-sm-10">
                <input id="emailInput" type="text" name="email" placeholder="사용자 이메일" required>
            </div>
        </div>
        <div class="form-group">
